...
int main() {
    ...
    while (true) {
        ...
        if (pos0 <0.0f) printf("Implausible\n");
        if (pos0>100.0f) printf("Implausible\n");
        if (pos1<0.0f) printf("Implausible\n");
        if (pos1>100.0f) printf("Implausible\n");


        // Checks for implausibility condition
